...
export default angular.module('testsite', [uirouter, footer, main, records, vdp, filterBank, pagination, vdpActions, vdpBanner, vdpDealer, vdpImages, vdpInfo, vdpSimilar])
  .config(config)
  .config(routes)
